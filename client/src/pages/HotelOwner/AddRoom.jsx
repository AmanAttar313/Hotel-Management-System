...
const AddRoom = () => {
  ...
  return (
    <form className='m-8'>
      <Title align='left' font='outfit' title='Add Rooms' subtitle='Fill in the Detail carefully and accurate
      room details, pricing, and amenities, to enhace user booking experince '/>
      ...
      <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
        {Object.keys(images).map((key)=>(
          <label htmlFor={`roomImages${key}`}key={key}>
            ...
            src={images[key] ? URL.createObjectURL(images[key]): assets.uploadArea} alt="" srcset="" />
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        ...
        <div>
          <p className='mt-4 text-gray-800'>
            ...
            rounded p-2 w-24 ' value={inputs.pricePerNight} 
            onChange={e=>({...inputs,pricePerNight:e.target.value})}/>
        </div>
      </div>
