...
import { assets, userBookingsDummyData } from '../asset/assets'

const MyBookings = () => {
    const [bookings,setBookings]=useState(userBookingsDummyData)
  return (
    <div className='py-28 md:pt-32 px-4 md:pb-35 md:px-16 lg:px-24 xl:px-32'>
           ...
           <div className='flex flex-col md:flex-row'>
            ...
            <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                ...
                <div className='flex items-center gap-1 text-sm text-gray-500'>
                    <img src={assets.locationIcon} alt="location-icon" srcset="" />
                    <span>{booking.hotel.address}</span>
                </div>
                   <div className='flex items-center gap-1 text-sm text-gray-500'>
                    <img src={assets.guestsIcon} alt="guests-icon" srcset="" />
...
{/* ------date & timing----- */}
<div className="grid grid-cols-[auto_auto] mt-6">
